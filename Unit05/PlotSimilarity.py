...
if __name__ == "__main__":
    ...
    text06 = """投票/要努力宣傳出去/當天不要早上一早去投
    要下午一至三點去投
    這樣開出來的票才會在四點一驗收票開出來的藍會多於綠票,
    樣他不好做票噢,,這是我四年前跟二年前去做選務人員心得,
    綠年青人都睡到中午下午才去投票,,結果一開票綠票下午多人投就開出綠領先,,這樣很好做票"""
    ...
    verbSeq01 = verbListExtraction(text10)  #將 text01 送入剛才的步驟處理，得到它的動詞序列
    verbSeq02 = verbListExtraction(text11)  #將 text02 送入剛才的步驟處理，得到它的動詞序列
    ...
    print('兩文本的脈絡相似度：{}%'.format(round(alignments[0].score/baseLength*100,3))) #最後輸出兩文本的相似度